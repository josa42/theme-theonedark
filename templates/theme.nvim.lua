...
local colors = {
  Blue           = "{{ .Blue.Hex           }}",
  Cyan           = "{{ .Cyan.Hex           }}",
  DarkYellow     = "{{ .DarkYellow.Hex     }}",
  Green          = "{{ .Green.Hex          }}",
  Purple         = "{{ .Purple.Hex         }}",
  Red            = "{{ .Red.Hex            }}",
  White          = "{{ .White.Hex          }}",
  BackgroundGrey = "{{ .BackgroundGrey.Hex }}",
  Black          = "{{ .Black.Hex          }}",
...
-- hi! TelescopeNormal         guibg={{.BackgroundGrey.Hex }}
-- hi! TelescopeBorder         guibg={{.BackgroundGrey.Hex }} guifg={{.Grey.Hex }}
-- hi! TelescopePreviewBorder  guibg={{.Black.Hex }} guifg={{.Grey.Hex }}
