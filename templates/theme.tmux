...
onedark_black="{{.Black.Gui}}"
onedark_blue="{{.Blue.Gui}}"
onedark_yellow="{{.Yellow.Gui}}"
onedark_red="{{.Red.Gui}}"
onedark_white="{{.White.Gui}}"
onedark_green="{{.Green.Gui}}"
onedark_visual_grey="{{.VisualGrey.Gui}}"
onedark_comment_grey="{{.Grey.Gui}}"
...
et "display-panes-colour" "$onedark_blue"
